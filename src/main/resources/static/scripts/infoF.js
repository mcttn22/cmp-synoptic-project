...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    .then (responseData =>{ console.log(responseData)
        ...
        ['Toilet ID', 'Block ID', 'Toilet Status', 'Compost Status'].forEach(headerText => {
        ...
        if (block.toilets && block.toilets.length > 0) {
          for (const toilet of block.toilets) {
            ...
            [toilet.toiletId, toilet.blockId, toilet.toiletStatus, toilet.compostStatus].forEach(celltext => {
